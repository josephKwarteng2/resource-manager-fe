...
export class ButtonNewComponent {
  ...
  constructor(private usercreationmodalService: UsercreationModalService, private managerusercreationmodalService: ManagerUsercreationService) {}

  openUserCreationModal() {

    this.usercreationmodalService.openUserCreationModal().result.finally(() => {

    });
  }
  openManagerUserCreationModal() {
    
    this.managerusercreationmodalService.openManagerUserCreationModal().result.finally(() => {
